    ...
    <div class="row">
        <div class="col-md-4 col-md-offset-4">
            <h3 class="page-header">
                <i class="fa fa-fw fa-plus"></i> Add Sponsor
            </h3>
        </div>
        <div class="col-md-4 col-md-offset-4">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h4><i class="fa fa-fw fa-plus"></i> <?php echo "$swimmer_first_name $swimmer_last_name" ?></h4>
                </div>
                <div class="panel-body">
                    <?php
                    echo '<p>Distance Swum: <strong>'.number_format($distance_swum).'</strong></p>';
                    ?>
                    <form action="add_sponsor_process.php" method="POST">
                        <div class="form-group">
                            <label for="inputSponsorName">Sponsor Name</label>
                            <input type="text" class="form-control" id="inputSponsorName" name="sponsor_name" required>
                        </div>
                        <div class="form-group">
                            <div class="radio">
                                <label>
                                    <input type="radio" name="sponsor_type" id="perMeter" value="0" checked>
                                    Per Meter
                                </label>
                            </div>
                            <div class="radio">
                                <label>
                                    <input type="radio" name="sponsor_type" id="fixedAmount" value="1">
                                    Fixed Amount
                                </label>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="inputSponsorAmount">Amount (IDR)</label>
                            <input type="number" class="form-control" id="inputSponsorAmount" name="sponsor_amount" required>
                        </div>
